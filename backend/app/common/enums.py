...
class AuditAction(StrEnum):
    """动作枚举（ts02 §8.3 + TS-05 §5.2 扩展：PROVIDER_FALLBACK 为 fallback 审计专用）。"""
    CREATE, UPDATE, APPROVE, REJECT, EXECUTE, REVERSE, SUPERSEDE, STATUS_CHANGE, LOGIN, PROVIDER_FALLBACK, FRESHNESS_CHANGE, PERMISSION_DENIED = (
        "CREATE", "UPDATE", "APPROVE", "REJECT", "EXECUTE",
        "REVERSE", "SUPERSEDE", "STATUS_CHANGE", "LOGIN", "PROVIDER_FALLBACK",
        "FRESHNESS_CHANGE", "PERMISSION_DENIED")
